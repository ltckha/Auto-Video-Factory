...
const subtitleStyleRegistry = {
  vibrant_sticker_label: {
    displayName: "vibrant_sticker_label",
    font: "Helvetica Neue",
    fontsize: 74,
    fontcolor: "0x111111",
    borderw: "2",
    bordercolor: "0x111111@0.8",
    shadowx: "0",
    shadowy: "2",
    shadowcolor: "0x000000@0.3",
    box: false,
    graphicTemplate: "vibrant_yellow_sticker",
    animation: "rotated_sticker_pop",
  },

  vibrant_yellow_lightning: {
    displayName: "vibrant_yellow_lightning",
    font: "Helvetica Neue",
    fontsize: 74,
    fontcolor: "0x111111",
    borderw: "2",
    ...
    shadowcolor: "0x000000@0.3",
    box: false,
    graphicTemplate: "vibrant_yellow_lightning",
    animation: "rotated_sticker_pop",
  },

  minimal_glass_card: {
    displayName: "minimal_glass_card",
    font: "Helvetica Neue",
    fontsize: 70,
    fontcolor: "0xFFFFFF",
    borderw: "2",
    ...
    box: false,
    graphicTemplate: "minimal_glass_card",
    animation: "smooth_blur_reveal",
  },

  warning_red_badge: {
    displayName: "warning_red_badge",
    font: "Helvetica Neue",
    fontsize: 76,
    fontcolor: "0xFFFFFF",
    borderw: "3",
    bordercolor: "0xFFFFFF@0.95",
    shadowx: "0",
    shadowy: "4",
    shadowcolor: "0x000000@0.5",
    box: false,
    graphicTemplate: "warning_red_badge",
    animation: "stomp_zoom",
  },

  neon_cyber_card: {
    displayName: "neon_cyber_card",
    font: "Helvetica Neue",
    fontsize: 72,
    fontcolor: "0x00F0FF",
    borderw: "2",
    bordercolor: "0x00F0FF@0.9",
    shadowx: "0",
    shadowy: "0",
    shadowcolor: "black@0.0",
    box: false,
    graphicTemplate: "warning_red_badge",
    animation: "word_by_word_bounce",
  },

  editorial_clean_text: {
    displayName: "editorial_clean_text",
    font: "Helvetica Neue",
    fontsize: 76,
    fontcolor: "0xFFFFFF",
    borderw: "2",
    bordercolor: "0x111111@0.6",
    shadowx: "0",
    shadowy: "3",
    shadowcolor: "0x000000@0.4",
    box: false,
